...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubPipelineInput) DeepCopyInto(out *SubPipelineInput) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubPipelineInput.
func (in *SubPipelineInput) DeepCopy() *SubPipelineInput {
	if in == nil {
		return nil
	}
	out := new(SubPipelineInput)
	in.DeepCopyInto(out)
	return out
}
